...
<head>
	...
	<script src="<?=$site['baseURL']?>lib/imageswap.js" language="javascript" type="text/javascript"></script>
		...
		<div id="pageContent">
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr valign="top">
					...
					<td width="423" id="leftCol"><?=$leftContent ?></td>
					<td width="9"><img src="img/spacer.gif" alt="" height="1" width="9"></td>
					<td width="340" id="rightCol"><?=$rightContent ?></td>
